...
class OrganizationsTest < ApplicationSystemTestCase
  ...
  test "creating a Organization" do
    ...
    check "Is producer" if @organization.is_producer
    check "Is validator" if @organization.is_validator
    fill_in "Name", with: @organization.name
    fill_in "Readable ids", with: @organization.readable_ids
    fill_in "Type", with: @organization.type
    fill_in "Writable ids", with: @organization.writable_ids
